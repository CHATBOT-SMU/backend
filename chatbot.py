...
academics = [
    ...
    ['(.*)(Software Engineering|software)(.*)', ['MedTech’s Software Engineering SWE program provides a combination of advanced technical and theoretical knowledge, best engineering practices, and emerging technologies to develop software that meet high quality standards.']],
